...
for i in range(len(data)):
    ...
    if d>0:
        ...
        cmd.append('python test_hyper.py --img-list data/data_lesion_cross1/ --model-dir checkpoints/combiner2_cross1/{}  --mod 2 --load-weights {}  --gpu 0 --hyper_val ,{:>6f},{:>6f},{:>6f},{:>6f}   --pred-dir Pred_dir/combiner2_cross1/{} >checkpoints/combiner2_cross1/{}/test_log\n'.format(i,e,a,b,c,d,i,i))

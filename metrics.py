...
def OD_PR(tgt, img, thre):
    ...
    label_tgt, number_of_tgts=measure.label(tgt, background = 0, return_num = True, connectivity=3)
    label_pred, number_of_preds=measure.label(img, background = 0, return_num = True, connectivity=3)
    tp_list=[]
...
def pn_rate(tgt, img, thre, direct='gt'):
    ...
    if direct=='pred':
        label_image, number_of_labels=measure.label(img, background = 0, return_num = True, connectivity=3)
        y_last=tgt
    elif direct=='gt':
        y_last=img
        label_image, number_of_labels=measure.label(tgt, background = 0, return_num = True, connectivity=3)
